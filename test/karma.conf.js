...
module.exports = function(config) {
    ...
    config.set({
        ...
        files: [
            ...
            'bower_components/js-polyfills/es2016.js',
            'bower_components/js-polyfills/html.js',
            'bower_components/js-polyfills/dom.js',
            'bower_components/js-polyfills/xhr.js',
            'bower_components/js-polyfills/url.js',
            'bower_components/js-polyfills/fetch.js',
            'bower_components/js-polyfills/cssom.js',
            'bower_components/js-polyfills/timing.js',
            'bower_components/js-polyfills/keyboard.js',
            'bower_components/js-polyfills/typedarray.js',
